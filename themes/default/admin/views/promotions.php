...
<head>
    ...
    <title>Cajam mult-store Promotional Page</title>
        ...
        <div class="site-wrapper-inner">
            <div class="cover-container">
                ...
                <div class="inner cover">
                    <h1 class="cover-heading">POS Module for Cajam mult-store</h1>
                    <p class="lead">Cajam mult-store is a PHP-based web application for small and medium businesses to manage inventory, sales (with online payments), expenses, customers, and warehouses. </p>
                    <p>Please edit themes/<?=$Settings->theme;?>/admin/views/promotions.php</p>
                </div>
                <div class="mastfoot">
                    <div class="inner">
                        <p>Cajam mult-store by <a href="http://cajam.co.tz">cajam mult-store</a>.</p>
                    </div>
                </div>
            </div>
        </div>
