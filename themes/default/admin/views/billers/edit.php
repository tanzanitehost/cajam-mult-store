            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div id="logo-con" class="text-center"><img
                            src="<?= base_url('assets/uploads/logos/' . $biller->logo) ?>" alt="" class="img-responsive" style="max-height: 120px; width: auto; height: auto; max-width: 100%;"></div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6">
...
<script type="text/javascript" charset="utf-8">
    $(document).ready(function () {
        $('#biller_logo').change(function (event) {
            ...
            $('#logo-con').html('<img src="<?=base_url('assets/uploads/logos')?>/' + biller_logo + '" alt="" class="img-responsive" style="max-height: 120px; width: auto; height: auto; max-width: 100%;">');
        });
    });
</script>
<?= $modal_js ?>
